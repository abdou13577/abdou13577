...
export default function ListingDetailScreen() {
  ...
  const handleSendOffer = async () => {
    if (!offerPrice) {
      Alert.alert('خطأ', 'يرجى إدخال السعر المعروض');
      return;
    }
    ...
    try {
      ...
      Alert.alert('نجح!', 'تم إرسال العرض بنجاح');
      setShowOfferModal(false);
      setOfferPrice('');
      setOfferMessage('');
    } catch (error: any) {
      Alert.alert('خطأ', error.response?.data?.detail || 'فشل إرسال العرض');
    } finally {
      setSending(false);
    }
  };
    ...
    <View style={styles.container}>
      ...
      <ScrollView>
        ...
        <View style={styles.mainInfo}>
          <Text style={styles.price}>{listing.price} دولار</Text>
          <Text style={styles.title}>{listing.title}</Text>

          <View style={styles.metaInfo}>
            <View style={styles.metaItem}>
              <Ionicons name="eye" size={16} color="#8E8E93" />
              <Text style={styles.metaText}>{listing.views} مشاهدة</Text>
            </View>
            <View style={styles.metaItem}>
        ...
        {/* Category Fields */}
        {listing.category_fields &&
          Object.keys(listing.category_fields).length > 0 && (
            <View style={styles.section}>
      ...
      {!isOwner && (
        <View style={styles.footer}>
          ...
          >
            ...
            <Text style={styles.offerButtonText}>إرسال عرض</Text>
          </TouchableOpacity>
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            ...
            <View style={styles.modalBody}>
              <Text style={styles.modalLabel}>السعر المعروض (دولار)</Text>
              <TextInput
              ...
              <Text style={styles.modalLabel}>رسالة (اختياري)</Text>
              <TextInput
              ...
              >
                {sending ? (
                  ...
                  <Text style={styles.sendOfferButtonText}>إرسال العرض</Text>
                )}
              </TouchableOpacity>
            </View>
          </View>
