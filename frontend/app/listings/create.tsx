...
const styles = StyleSheet.create({
  ...
  videoPlaceholder: { width: 100, height: 100, backgroundColor: COLORS.background, borderRadius: 12, justifyContent: 'center', alignItems: 'center', borderWidth: 2, borderColor: COLORS.gold },
  videoText: { fontSize: 10, color: COLORS.textPrimary, marginTop: 4 },
  addVideoText: { fontSize: 10, color: COLORS.textPrimary, marginTop: 4 },
