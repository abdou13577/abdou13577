...
const styles = StyleSheet.create({
  ...
  form: { width: '100%' },
  inputContainer: { flexDirection: 'row', alignItems: 'center', backgroundColor: COLORS.cardBackground, borderRadius: 12, marginBottom: 16, paddingHorizontal: 16, borderWidth: 1, borderColor: COLORS.border },
  ...
  loginButtonDisabled: { backgroundColor: COLORS.textMuted, opacity: 0.5 },
  loginButtonText: { color: COLORS.black, fontSize: 18, fontWeight: '600', textAlign: 'center' },
