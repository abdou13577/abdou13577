...
const styles = StyleSheet.create({
  ...
  userEmail: { fontSize: 16, color: COLORS.textSecondary, marginBottom: 8 },
  userIdContainer: { flexDirection: 'row', alignItems: 'center', marginBottom: 12, gap: 6 },
  userId: { fontSize: 14, color: COLORS.textMuted, fontFamily: 'monospace' },
  ratingContainer: { flexDirection: 'row', alignItems: 'center', backgroundColor: COLORS.background, paddingHorizontal: 16, paddingVertical: 8, borderRadius: 20, borderWidth: 1, borderColor: COLORS.border, marginBottom: 16 },
  ratingText: { fontSize: 16, fontWeight: '600', color: COLORS.textPrimary, marginLeft: 6 },
  editButton: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', backgroundColor: COLORS.gold, paddingVertical: 10, paddingHorizontal: 24, borderRadius: 12, gap: 6 },
  editButtonText: { color: COLORS.black, fontSize: 16, fontWeight: '700' },
