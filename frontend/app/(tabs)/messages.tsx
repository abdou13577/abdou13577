...
const styles = StyleSheet.create({
  ...
  conversationCardUnread: { backgroundColor: COLORS.black },
  ...
  userNameUnread: { fontWeight: '700', color: COLORS.gold },
  rightSection: { flexDirection: 'row', alignItems: 'center', gap: 8 },
  timeText: { fontSize: 12, color: COLORS.textMuted },
  unreadBadge: { backgroundColor: COLORS.red, borderRadius: 10, minWidth: 20, height: 20, justifyContent: 'center', alignItems: 'center', paddingHorizontal: 6 },
  unreadText: { color: '#FFF', fontSize: 11, fontWeight: 'bold' },
  listingTitle: { fontSize: 14, color: COLORS.red, marginBottom: 4 },
  listingTitleUnread: { fontWeight: '600', color: COLORS.gold },
