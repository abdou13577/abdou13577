...
const styles = StyleSheet.create({
  ...
  listingPrice: { fontSize: 18, fontWeight: 'bold', color: COLORS.gold },
  vbBadge: { backgroundColor: COLORS.red, color: COLORS.textPrimary, fontSize: 12, fontWeight: '700', paddingHorizontal: 8, paddingVertical: 2, borderRadius: 4 },
  listingMeta: { flexDirection: 'row', alignItems: 'center', flexWrap: 'wrap' },
  listingLocation: { fontSize: 12, color: COLORS.textSecondary, marginLeft: 4, fontWeight: '500' },
