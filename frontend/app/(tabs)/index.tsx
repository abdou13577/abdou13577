  ...
  const renderCategory = ({ item }: { item: Category }) => (
    ...
    >
      <Ionicons
        ...
        size={24}
        color={selectedCategory === item.id ? '#FFFFFF' : '#007AFF'}
      />
      <Text
        style={[
          styles.categoryText,
  ...
  const renderListing = ({ item }: { item: Listing }) => (
    ...
    >
      ...
      <View style={styles.listingInfo}>
        ...
        <Text style={styles.listingPrice}>{item.price} دولار</Text>
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.headerTitle}>إعلانات كلاسيكية</Text>
      </View>
      ...
      <View style={styles.categoriesSection}>
        <FlatList
          ...
          data={[{ id: null, name_ar: 'الكل', icon: 'apps' }, ...categories] as any}
